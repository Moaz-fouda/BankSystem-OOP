...
private:
    ...
    static void _GoBackToManageUsersMenue()
    {
        ...
        {
            clsListUser::_ShowUserListScreen();
        ...
        static void _PerformeMangeUsers(enManageUsersMenueOptions ch) {
            switch (ch) {
...
public:
    static void ShowManageUsersMenue()
    {
        ...
        cout << setw(37) << left << "" << "===========================================\n";
        _PerformeMangeUsers((enManageUsersMenueOptions)_ReadManageUsersMenueOption());
    }
